...
Vue.component( 'a-clock', {
  ...
  template: "<div class=\"component-clock\"><span class=\"hour\">{{hour}}</span>:<span class=\"min\">{{min}}</span></div>",
  created: function () {
...
Vue.component( 'posts', {
  ...
  template: "<form><input placeholder=\"Please input search substring here ...\" type=\"text\" v-model=\"searchString\" /><ul><li v-for=\"post in filteredPosts\"><a v-bind:href=\"post.path\">{{post.name}}</a></li></ul></form>",
//  created: function () {
//    console.log( '[clock] created' );
//    this.dt = new Date( Date.UTC( 2000, 0, 1, this.initHour, this.initMin - 1, 0 ) );
//    this.tick();
...
(function(){'object' != typeof VComponents && (this.VComponents = {});
